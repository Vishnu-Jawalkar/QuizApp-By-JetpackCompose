...
import com.example.quizapp.ui.Dimens.MediumBoxHeight
import com.example.quizapp.ui.Dimens.MediumTextSize
import com.example.quizapp.ui.Dimens.SmallCircleShape
...
fun Prev(){
    ...
    QuizOption(
        optionNumber = "A",
        options = " Hi Guys! This is a Quiz answer",
        selected = false,
        onOptionClick = {},
        onUnselectedOption = {},
    )
...
)
{
    ...
    Box(
        ...
        )
        {
            ...
            Spacer(modifier = Modifier.width(SmallCircleShape).weight(0.6f))
